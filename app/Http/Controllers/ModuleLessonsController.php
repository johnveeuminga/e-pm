                                ...
                                ->joinSub($correct_answers_join_sub, 'QA', function($join){
                                    $join->on(function ($join) {
                                            $join->on('QA.qo_id', '=', 'question_attempt_answers.answer')
                                                ...
                                                ->orOn(DB::raw('CAST(QA.name as DECIMAL(10, 3))'), '=', DB::raw('CAST(question_attempt_answers.answer as DECIMAL(10, 3))'));
                                        })->on('question_attempt_answers.question_id', '=', 'QA.question_id');
                                })
                                ->where('user_id', $user->id);
                        });
